...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/harfbuzz-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/harfbuzz-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add harfbuzz libharfbuzz libharfbuzz-devel
# for installing globally
pixi global install harfbuzz libharfbuzz libharfbuzz-devel
```
...
It is possible to list all of the versions of `harfbuzz` available on your platform:
...
```
pixi search harfbuzz --channel conda-forge
```
